...
include_graphics(paste0(path, "Stats506_Project/R/EDA.png"))
...
include_graphics(paste0(path, "Stats506_Project/Stata/stata_reg_output.png"))
...
include_graphics(paste0(path, "Stats506_Project/Stata/kernel_dens_reg.jpg"))
cap_Stata2 <- "Figure 2.2 Kernel Density Plot"
```

```{r, echo = FALSE, fig.cap = cap_Stata3}
include_graphics(paste0(path, "Stats506_Project/Stata/pnorm_reg.jpg"))
cap_Stata3 <- "Figure 2.3 Pnorm Plot"
```

```{r, echo = FALSE, fig.cap = cap_Stata4}
include_graphics(paste0(path, "Stats506_Project/Stata/qnorm_reg.jpg"))
cap_Stata4 <- "Figure 2.4 Qnorm Plot"
```
...
include_graphics(paste0(path, "Stats506_Project/Stata/scatter_fit_plots.jpg"))
cap_Stata5 <- "Figure 2.5 Fitted Plot - Linear (red), polynomial (green), 
...
include_graphics(paste0(path, "Stats506_Project/Stata/cubic_polynom.png"))
cap_Stata6 <- "Figure 2.6 Regression with Cubic polynomial for Age"
```  
...
include_graphics(paste0(path, "Stats506_Project/Stata/step_wise.png"))
...
include_graphics(paste0(path, "Stats506_Project/Stata/Step_function.jpg"))
...
include_graphics(paste0(path, "Stats506_Project/Stata/spline_reg.png"))
...
include_graphics(paste0(path, "Stats506_Project/Stata/basis_spline.jpg"))
cap_Stata10 <- "Figure 2.10 Step-wise regression for Age with 6 bins"
```  
...
source(paste0(path, "Stats506_Project/R/User-written functions.R"))
``` 

```{r User-written function.R, warning = FALSE, echo = FALSE}
readLines(paste0(path, "Stats506_Project/R/User-written functions.R"))
```
</details>
...
```{r basis_plot, echo = FALSE, fig.cap = cap_R7}
wage_age(TRUE, 1, y ~ bs(x,df = 6))
cap_R7 <- "Figure 3.7 Scatter plot between Wage and Age with Regression line.
(Basis Spline)"
```


Then consider the Natural Spline.
```{r, echo = FALSE, fig.cap = cap_R8}
plot_kfold(bs = FALSE)
cap_R8 <- "Figure 3.8 The MSE of the natural spline from performing 
5-fold cross validation"
```
...
```{r natural_plot, echo = FALSE, fig.cap = cap_R9}
wage_age(TRUE, 1, y ~ ns(x, df = 6))
cap_R9 <- "Figure 3.9 Scatter plot between Wage and Age with Regression line.
(Natural Spline)"
```
